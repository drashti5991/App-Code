<!--
File          : Step1.jsp
Description   : This page is the 1st step in the 5-step application. User will 
                not be able to go to the Welcome page or any of the next steps 
                using the drop-down menu. The user needs to Submit to move to 
                the next step/farthest step in the application.
